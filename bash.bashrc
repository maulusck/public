...
alias aliases='nano /home/m4ulu5ck/.bashrc'
alias mpv.='mpv .'
alias amirror='scrcpy  --window-x 1024 --window-width 450 --window-height 1024 --shortcut-mod=rctrl --window-title=SCRCPY & exit'
alias duck='firefox --search'
...
alias vpnbook='cd ~/privacy/vpnbook/ && printf "Password is: " && cat pw-vpnbook.txt && printf "You may want to copy the following command:\nsudo openvpn --config VPN\n"'
